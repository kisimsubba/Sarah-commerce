...
$tabs = ['summary' => ['label' => \__('Summary', 'staatic'), 'url' => \admin_url(\sprintf('admin.php?page=%s&id=%s', PublicationSummaryPage::PAGE_SLUG, $publication->id()))], 'results' => ['label' => \__('Resources', 'staatic'), 'url' => \admin_url(\sprintf('admin.php?page=%s&id=%s', PublicationResultsPage::PAGE_SLUG, $publication->id()))], 'logs' => ['label' => \__('Logs', 'staatic'), 'url' => \admin_url(\sprintf('admin.php?page=%s&id=%s', PublicationLogsPage::PAGE_SLUG, $publication->id()))]];
?>
