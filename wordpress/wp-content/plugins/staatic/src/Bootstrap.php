...
final class Bootstrap
{
    ...
    {
        $this->isDevMode = (bool) ($_ENV['STAATIC_DEV_MODE'] ?? \false);
        $this->isDebug = (bool) ($_ENV['STAATIC_DEBUG'] ?? \false);
        $this->isPremium = ($_ENV['STAATIC_PREMIUM'] ?? \true) && \is_dir(__DIR__ . '/../premium');
