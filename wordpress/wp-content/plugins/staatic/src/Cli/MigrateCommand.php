...
class MigrateCommand
{
    ...
    /**
     * Applies database migrations when upgrading or downgrading the plugin.
     *
     * ## OPTIONS
     *
     * <target>
     ...
     * @return void
     */
    private function migrateNamespace(string $namespace, string $targetVersion)
    {
