...
final class UrlTransformerFactory
{
     ...
     * @param UriInterface|null $destinationUrl
     */
    public function __invoke($baseUrl = null, $destinationUrl = null) : UrlTransformerInterface
    {
        ...
        if ($baseUrl === null) {
            $baseUrl = $this->siteUrlProvider->provide();
        }
