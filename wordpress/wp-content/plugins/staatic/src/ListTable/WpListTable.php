...
final class WpListTable extends WP_List_Table
{
    ...
    public function __construct(AbstractListTable $listTable)
    {
    ...
    public function prepare_items()
    {
        ...
        list($orderBy, $direction) = $this->getOrder();
    ...
    protected function getOrder() : array
    {
        ...
        if (isset($_REQUEST['orderby'])) {
            ...
            if (\array_key_exists($inputOrderBy, $sortableColumns)) {
                list($orderBy, $direction) = $sortableColumns[$inputOrderBy];
            }
        }
    ...
    protected function get_views()
    {
        ...
        if ($numItemsPerView === null) {
            ...
            $allLabel = \sprintf(
                ...
                \number_format_i18n($numItemsTotal)
            );
        }
        $result = [];
        $result['all'] = \sprintf(
