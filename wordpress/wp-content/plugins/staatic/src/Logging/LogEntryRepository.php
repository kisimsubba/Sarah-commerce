...
final class LogEntryRepository
{
    ...
    {
        return new LogEntry((string) UuidV4::fromBytes($row['uuid']), new DateTimeImmutable(
            $row['log_date']
     ...
     * @return void
     */
    public function deleteOlderThan(int $numDays, array $excludePublicationIds = [])
    {
     ...
     * @param string|null $query
     */
    public function countWhereMatching(string $publicationId, $level = null, $query = null) : int
    {
