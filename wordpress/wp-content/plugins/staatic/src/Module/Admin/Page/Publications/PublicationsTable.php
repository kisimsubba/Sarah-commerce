...
class PublicationsTable extends AbstractListTable
{
    ...
    public function setupRowActions()
    {
        $this->addRowActions([
            new RowAction('details', \__('Details', 'staatic'), function ($itemId) {
                    ...
                    }), new RowAction('redeploy', \__('Redeploy', 'staatic'), function ($itemId) {
                        return \wp_nonce_url(
     ...
     * @return void
     */
    public function setupBulkActions()
    {
     ...
     * @return string|null
     */
    private function activePublicationId()
    {
    ...
    {
        return $publication->deployment()->isFinished();
    }
