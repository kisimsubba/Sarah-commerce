...
final class S3ObjectAcl extends AbstractSetting
{
    ...
    public function description()
    {
        return \sprintf(
            ...
            \__('Optionally apply the provided (canned) ACL to uploaded files.<br>For more information, see <a href="%1$s" target="_blank" rel="noopener">Canned ACL documentation</a>.', 'staatic'),
