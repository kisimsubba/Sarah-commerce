...
{
    const VALUE_HTML5 = CrawlOptions::DOM_PARSER_HTML5;

    const VALUE_DOM_WRAP = CrawlOptions::DOM_PARSER_DOM_WRAP;

    const VALUE_SIMPLE_HTML = CrawlOptions::DOM_PARSER_SIMPLE_HTML;
