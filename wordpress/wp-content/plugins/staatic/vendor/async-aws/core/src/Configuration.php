...
final class Configuration
{
    ...
    const OPTION_ACCESS_KEY_ID = 'accessKeyId';
    const OPTION_SECRET_ACCESS_KEY = 'accessKeySecret';
    const OPTION_SESSION_TOKEN = 'sessionToken';
    const OPTION_SHARED_CREDENTIALS_FILE = 'sharedCredentialsFile';
    const OPTION_SHARED_CONFIG_FILE = 'sharedConfigFile';
    const OPTION_ENDPOINT = 'endpoint';
    const OPTION_ROLE_ARN = 'roleArn';
    const OPTION_WEB_IDENTITY_TOKEN_FILE = 'webIdentityTokenFile';
    const OPTION_ROLE_SESSION_NAME = 'roleSessionName';
    const OPTION_CONTAINER_CREDENTIALS_RELATIVE_URI = 'containerCredentialsRelativeUri';
    const OPTION_ENDPOINT_DISCOVERY_ENABLED = 'endpointDiscoveryEnabled';
    const OPTION_PATH_STYLE_ENDPOINT = 'pathStyleEndpoint';
    const OPTION_SEND_CHUNKED_BODY = 'sendChunkedBody';
     ...
     * @return void
     */
    private static function populateConfiguration(Configuration $configuration, array $options)
    {
