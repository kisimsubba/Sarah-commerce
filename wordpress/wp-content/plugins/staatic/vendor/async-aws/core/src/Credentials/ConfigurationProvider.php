...
final class ConfigurationProvider implements CredentialProvider
{
     ...
     */
    public function __construct($httpClient = null, $logger = null)
    {
     ...
     * @return Credentials|null
     */
    private function getCredentialsFromRole(Credentials $credentials, string $region, string $roleArn, string $roleSessionName = null)
    {
