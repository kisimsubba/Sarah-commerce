...
class Response
{
     ...
     */
    public function resolve($timeout = null) : bool
    {
     ...
     * @return mixed[]
     */
    public static final function wait($responses, $timeout = null, $downloadBody = \false)
    {
        $responseMap = [];
        $indexMap = [];
        $httpResponses = [];
     ...
     * @return void
     */
    private function defineResolveStatus()
    {
        try {
