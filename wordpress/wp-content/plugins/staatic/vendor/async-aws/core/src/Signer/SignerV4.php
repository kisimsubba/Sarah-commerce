...
class SignerV4 implements Signer
{
     ...
     * @return void
     */
    protected function convertBodyToStream($context)
    {
     ...
     * @return void
     */
    private function handleSignature(Request $request, Credentials $credentials, DateTimeImmutable $now, DateTimeImmutable $expires, bool $isPresign)
    {
     ...
     * @return void
     */
    private function removePresign(Request $request)
    {
     ...
     * @return void
     */
    private function sanitizeHostForHeader(Request $request)
    {
     ...
     * @return void
     */
    private function assignAmzQueryValues(Request $request, Credentials $credentials, bool $isPresign)
    {
        if ($isPresign) {
     ...
     * @return void
     */
    private function buildTime(Request $request, DateTimeImmutable $now, DateTimeImmutable $expires, bool $isPresign)
    {
        if ($isPresign) {
     ...
     * @return void
     */
    private function convertHeaderToQuery(Request $request)
    {
     ...
     * @return void
     */
    private function convertBodyToQuery(Request $request)
    {
