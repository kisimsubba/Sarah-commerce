...
{
    const ALGORITHM_CHUNK = 'AWS4-HMAC-SHA256-PAYLOAD';
    const CHUNK_SIZE = 64 * 1024;
    const MD5_OPERATIONS = ['DeleteObjects' => \true, 'PutBucketCors' => \true, 'PutBucketLifecycle' => \true, 'PutBucketLifecycleConfiguration' => \true, 'PutBucketPolicy' => \true, 'PutBucketTagging' => \true, 'PutBucketReplication' => \true, 'PutObjectLegalHold' => \true, 'PutObjectRetention' => \true, 'PutObjectLockConfiguration' => \true];
    ...
    protected function convertBodyToStream($context)
    {
        ...
        $body = RewindableStream::create(IterableStream::create((function (RequestStream $body) use($context) {
            $now = $context->getNow();
