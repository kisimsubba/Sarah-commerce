...
class File
{
     ...
     * @param int $when
     */
    protected static final function dosTime($when) : int
    {
        $d = \getdate($when);
        if ($d['year'] < 1980) {
     ...
     * @return void
     */
    protected function processStreamWithZeroHeader($stream)
    {
     ...
     * @return void
     */
    protected function readStream($stream, $options = null)
    {
        $this->deflateInit();
        $total = 0;
     ...
     * @return void
     */
    protected function deflateData($stream, &$data, $options = null)
    {
     ...
     * @return void
     */
    protected function processStreamWithComputedHeader($stream)
    {
