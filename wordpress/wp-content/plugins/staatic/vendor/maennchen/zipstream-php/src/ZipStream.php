...
class ZipStream
{
     ...
     * @param ArchiveOptions|null $opt
     */
    public function __construct($name = null, $opt = null)
    {
     ...
     * @return void
     */
    public function addFile($name, $data, $options = null)
    {
     ...
     * @return void
     */
    public function addFileFromPath($name, $path, $options = null)
    {
        $options = $options ?: new FileOptions();
        $options->defaultTo($this->opt);
        $file = new File($this, $name, $options);
     ...
     * @return void
     */
    public function addFileFromStream($name, $stream, $options = null)
    {
        $options = $options ?: new FileOptions();
        $options->defaultTo($this->opt);
        $file = new File($this, $name, $options);
     ...
     * @return void
     */
    public function addFileFromPsr7Stream($name, $stream, $options = null)
    {
        $options = $options ?: new FileOptions();
        $options->defaultTo($this->opt);
        $file = new File($this, $name, $options);
