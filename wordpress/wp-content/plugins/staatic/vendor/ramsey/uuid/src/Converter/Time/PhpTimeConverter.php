...
{
    const GREGORIAN_TO_UNIX_INTERVALS = 0x1b21dd213814000;
     ...
     * @param TimeConverterInterface|null $fallbackConverter
     */
    public function __construct($calculator = null, $fallbackConverter = null)
    {
        if ($calculator === null) {
