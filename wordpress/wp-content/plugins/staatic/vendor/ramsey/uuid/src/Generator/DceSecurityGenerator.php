...
{
    const DOMAINS = [Uuid::DCE_DOMAIN_PERSON, Uuid::DCE_DOMAIN_GROUP, Uuid::DCE_DOMAIN_ORG];
    const CLOCK_SEQ_HIGH = 63;
    const CLOCK_SEQ_LOW = 0;
    /**
    ...
    /**
     * @var \Staatic\Vendor\Ramsey\Uuid\Provider\DceSecurityProviderInterface
     */
