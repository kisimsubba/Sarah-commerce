...
class UuidBuilder implements UuidBuilderInterface
{
    ...
    /**
     * @param TimeConverterInterface|null $unixTimeConverter
     */
    public function __construct(NumberConverterInterface $numberConverter, TimeConverterInterface $timeConverter, $unixTimeConverter = null)
    {
