...
{
    use LoggerTrait;
    const FORMAT_BASIC = "\x1b[2m[%1\$s %2\$s]\x1b[0m \x1b[%4\$dm%5\$s\x1b[0m\n";
    const FORMAT_WITH_CONTEXT = "\x1b[2m[%1\$s %2\$s]\x1b[0m %3\$s\x1b[%4\$dm%5\$s\x1b[0m\n";
    const CONTEXT_FORMAT = "\x1b[2m[%s]\x1b[0m ";
    ...
    public function log($level, $message, $context = [])
    {
        ...
        $memory = \number_format(\memory_get_usage() / 1024 / 1024, 3) . ' MiB';
