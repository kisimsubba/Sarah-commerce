...
class StaticGenerator implements LoggerAwareInterface
{
    ...
    const STATS_UPDATE_FREQUENCY = 12;
    /**
     ...
     * @return void
     */
    private function updateInitializeCrawlerStats(Build $build, int $numEnqueued)
    {
     ...
     * @return void
     */
    private function updateCrawlStats(Build $build, int $numUrlsCrawled)
    {
