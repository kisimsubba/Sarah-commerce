...
use Staatic\Vendor\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
class PhpDumper extends Dumper
{
    ...
    /**
     * @var \Staatic\Vendor\Symfony\Component\DependencyInjection\ExpressionLanguage
     */
...
EOF;
     ...
     */
    private function addServiceMethodCalls(Definition $definition, string $variableName, $sharedNonLazyId) : string
    {
        $lastWitherIndex = null;
        foreach ($definition->getMethodCalls() as $k => $call) {
            if ($call[2] ?? \false) {
