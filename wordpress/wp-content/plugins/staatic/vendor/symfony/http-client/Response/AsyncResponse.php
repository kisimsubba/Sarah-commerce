...
final class AsyncResponse implements ResponseInterface, StreamableInterface
{
    ...
    const FIRST_CHUNK_YIELDED = 1;
    const LAST_CHUNK_YIELDED = 2;
    private $client;
    private $response;
    /**
     * @var mixed[]
     ...
     */
    private static function passthruStream(ResponseInterface $response, self $r, $chunk, $asyncMap) : Generator
    {
        while (\true) {
            try {
