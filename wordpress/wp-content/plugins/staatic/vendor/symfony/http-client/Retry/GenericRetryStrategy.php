...
class GenericRetryStrategy implements RetryStrategyInterface
{
    ...
    const DEFAULT_RETRY_STATUS_CODES = [0 => self::IDEMPOTENT_METHODS, 423, 425, 429, 500 => self::IDEMPOTENT_METHODS, 502, 503, 504 => self::IDEMPOTENT_METHODS, 507 => self::IDEMPOTENT_METHODS, 510 => self::IDEMPOTENT_METHODS];
    /**
     * @var mixed[]
     */
    private $statusCodes;
